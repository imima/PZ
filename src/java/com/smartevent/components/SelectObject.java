...
import com.smartevent.services.GenericSelectModel;
import com.smartevent.services.GenericValueEncoder;
...
public class SelectObject extends AbstractField
{
    ...
    private GenericSelectModel<Object> model;
...
//    private SelectModel model;
    ...
    void beginRender(MarkupWriter writer)
    {
        ...
        encoder = new GenericValueEncoder<Object>(list, labelField, propertyAccess);
        model = new GenericSelectModel<Object>(list, labelField, propertyAccess);
