...
import com.smartevent.dao.GenericDAO;
import com.smartevent.dao.HibernateEventDAOImpl;
import com.smartevent.dao.HibernateGenericDAOImpl;
import com.smartevent.dao.HibernateUserDAOImpl;
import com.smartevent.dao.UserDAO;
import com.smartevent.services.business.EventService;
import com.smartevent.services.business.EventServiceImpl;
import com.smartevent.services.business.UserService;
import com.smartevent.services.business.UserServiceImpl;
import com.smartevent.services.security.ProtectPageService;
...
public class AppModule {
    ...
    public static void bind(ServiceBinder binder) {
        binder.bind(GenericDAO.class, HibernateGenericDAOImpl.class);
        binder.bind(EventDAO.class, HibernateEventDAOImpl.class);
        binder.bind(UserDAO.class, HibernateUserDAOImpl.class);
        
        binder.bind(EventService.class, EventServiceImpl.class).eagerLoad();
        binder.bind(UserService.class, UserServiceImpl.class);
        binder.bind(ProtectPageService.class).withId("ProtectPageService"); 
        
        binder.bind(GenerateXMLService.class);
    ...
    public static void contributeApplicationDefaults(
        ...
        configuration.add(SymbolConstants.SUPPORTED_LOCALES, "en,de,sr,nl");
